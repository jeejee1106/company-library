...
public class SwaggerConfig {
    ...
    public Docket api() {
        return new Docket(DocumentationType.OAS_30)
                ...
                .apiInfo(apiInfo())
                .select()
                .apis(RequestHandlerSelectors.basePackage("com.example.companylibrary")) // Controller가 들어있는 패키지. 이 경로의 하위에 있는 api만 표시됨.
    ...
    public ApiInfo apiInfo() {
        return new ApiInfoBuilder()
                .title("Ezpmp 사내 도서 대출 시스템")
                .description("책을 빌릴 수 있어요")
                .version("0.1")
                .build();
    }
}